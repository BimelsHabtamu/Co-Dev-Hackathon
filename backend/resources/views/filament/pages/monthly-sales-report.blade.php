<x-filament-panels::page>
    ...
    <x-filament::section class="mt-4">
        <x-slot name="heading">Sales for {{ $year }}-{{ $month }}</x-slot>

        @if($sales->isEmpty())
            <p class="text-gray-400 text-center py-8">No sales found for this month.</p>
        @else
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                        ...
                        <td class="py-3 px-4 text-gray-500">{{ $sale->created_at->format('M d, H:i') }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
